...
Cloud services like AWS / Azure / Google Cloud will be used for hosting and scaling.   
...
The system can be developed in modular parts, making implementation easier.   
